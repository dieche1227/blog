    ...
    ImageButton = (function(_super) {
        ...
        ImageButton.prototype.renderMenu = function() {
            ...
            createInput = function() {
                ...
                return $input = $('<input type="file" title="上传图片" name="file" accept="image/*">').appendTo($uploadItem);
            };
            createInput();
            $uploadItem.on('click mousedown', 'input[name=file]', function(e) {
                return e.stopPropagation();
            });
            $uploadItem.on('change', 'input[name=file]', function(e) {
        ...
        ImageButton.prototype.decorate = function($img) {
            ...
            $wrapper = $(this._wrapperTpl).width( $img.width() == 0 ? '' : $img.width() );
            if ($parent.is('p')) {
    ...
    ImagePopover = (function(_super) {
        ...
        ImagePopover.prototype._initUploader = function() {
            ...
            createInput = function() {
                ...
                return _this.input = $('<input type="file" title="上传图片" name="file" accept="image/*">').appendTo($uploadBtn);
            };
            createInput();
            this.el.on('click mousedown', 'input[name=file]', function(e) {
                return e.stopPropagation();
            });
            return this.el.on('change', 'input[name=file]', function(e) {
